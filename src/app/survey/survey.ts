...
const MILIEU_MAP: Record<string, { name: string; farbe: string; desc: string; anteil: string }> = {
  traditionell_buergerlich: { name: 'Traditionell-Bürgerliche', farbe: '#5a8fa0', desc: 'Wertkonservativ, familien- und sicherheitsorientiert. Klare Strukturen, Pflichtbewusstsein und ein geregeltes Leben sind wichtig.', anteil: '10 %' },
  ...
  prekaer:                  { name: 'Prekäre', farbe: '#8b5e5e', desc: 'Um Orientierung und Teilhabe bemüht. Oft mit Ausgrenzungserfahrungen und sozialer Benachteiligung konfrontiert, dennoch zukunftsbezogen.', anteil: '9 %' },
  konsum_materialistisch:   { name: 'Konsum-Materialisten', farbe: '#c04a7a', desc: 'Freizeit-, marken- und erlebnisorientiert. Konsum und Spaß stehen im Vordergrund, oft mit Distanz zu Bildungseliten.', anteil: '13 %' },
  experimentalisten:        { name: 'Experimentalisten', farbe: '#d97706', desc: 'Spaß- und erlebnisorientiert, unkonventionell. Lieben Vielfalt, neue Reize und leben spontan im Hier und Jetzt.', anteil: '14 %' },
  neo_oekologisch:          { name: 'Neo-Ökologische', farbe: '#3a8fbf', desc: 'Nachhaltigkeits-, werte- und gerechtigkeitsorientiert. Reflektiert, weltoffen und mit starkem gesellschaftlichem Bewusstsein.', anteil: '15 %' },
...
const MILIEU_FOR_QUESTION: Record<string, string> = {
  q1: 'traditionell_buergerlich',
  q10: 'traditionell_buergerlich',
  q2: 'adaptiv_pragmatisch',
  q14: 'adaptiv_pragmatisch',
  q3: 'prekaer',
  q16: 'prekaer',
  q4: 'konsum_materialistisch',
  q18: 'konsum_materialistisch',
  q5: 'experimentalisten',
  q17: 'experimentalisten',
  q6: 'neo_oekologisch',
  q12: 'neo_oekologisch',
  q7: 'expeditiv',
  q9: 'expeditiv',
